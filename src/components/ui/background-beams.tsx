...
interface BeamsProps {
    ...
    scale?: number;
    rotation?: number;
    className?: string; // Added for integration
}
  ...
  vec3 getNormal(vec3 pos) {
    ...
    gl_FragColor.rgb -= randomNoise / 15. * uNoiseIntensity;`
                ...
                uniforms: {
                    ...
                    roughness: 0.2, // Lower roughness for sharper highlights (stronger shading)
                    metalness: 0.8, // Higher metalness for darker shadows and metallic contrast
...
>(({ material, width, count, height }, ref) => {
    ...
    const geometry = useMemo(
        () => createStackedPlanesBufferGeometry(count, width, height, 0, 100), // Zero spacing for perfect continuity without z-fighting
        [count, width, height]
    );
    useFrame((_, delta) => {
